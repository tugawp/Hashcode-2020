...
class Library:
    ...
    def heuristic(self, bookValues):
        return self.sumBookValues(bookValues) * self.nBooksPerSecond/ self.nSignupDays

    def heuristic2(self, bookValues):
        return self.sumBookValues(bookValues) / self.nSignupDays

    def heuristic3(self, bookValues, n_days_remain):
